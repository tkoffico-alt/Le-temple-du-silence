...
const MURMURES_DATABASE = [
    ...
    {
        title: "<span class='fr'>Paradoxe : La Guerre de l'Ego</span><span class='en' style='display:none;'>Paradox: The War of the Ego</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Celui qui déclare la guerre à son ego lui donne la solidité d'un roc. Celui qui l'observe avec la tendresse du Témoin le voit fondre comme de la neige au soleil.</div>
        <div class="en" style="display:none;">He who declares war on his ego gives it the solidity of a rock. He who observes it with the tenderness of the Witness sees it melt like snow in the sun.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : Le Véritable Silence</span><span class='en' style='display:none;'>Paradox: True Silence</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Le véritable silence intérieur n'est pas l'absence de bruit. C'est l'espace vaste et majestueux qui permet au vacarme du monde d'exister sans nous déranger.</div>
        <div class="en" style="display:none;">True inner silence is not the absence of noise. It is the vast and majestic space that allows the din of the world to exist without disturbing us.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : L'Illusion de l'Effort</span><span class='en' style='display:none;'>Paradox: The Illusion of Effort</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Tant que vous cherchez l'éveil avec l'acharnement d'un conquérant, il vous fuira. L'effort perpétue la tension ; c'est dans l'abandon que la porte s'ouvre.</div>
        <div class="en" style="display:none;">As long as you seek awakening with the relentlessness of a conqueror, it will elude you. Effort perpetuates tension; it is in surrender that the door opens.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : La Vase et l'Eau Claire</span><span class='en' style='display:none;'>Paradox: Mud and Clear Water</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Ne soyez pas surpris si de vieilles colères refont surface alors que vous pratiquez la paix. La vase ne remonte du fond que lorsque l'eau commence enfin à s'éclaircir.</div>
        <div class="en" style="display:none;">Do not be surprised if old angers resurface while you are practicing peace. The mud only rises from the bottom when the water finally begins to clear.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : Le Paratonnerre</span><span class='en' style='display:none;'>Echo: The Lightning Rod</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Sentir le froid du sol sous ses pieds nus n'est pas une distraction pour l'esprit. C'est le paratonnerre indispensable qui protecte le système nerveux de ses propres foudres.</div>
        <div class="en" style="display:none;">Feeling the cold ground beneath your bare feet is not a distraction for the mind. It is the indispensable lightning rod that protects the nervous system from its own lightning strikes.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : La Digestion Sacrée</span><span class='en' style='display:none;'>Echo: Sacred Digestion</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Un repas chaud, dense et lourd, mangé en pleine conscience lors d'une tempête émotionnelle, ancre l'âme bien plus efficacement qu'une heure de lévitation imaginaire.</div>
        <div class="en" style="display:none;">A hot, dense, and heavy meal, eaten mindfully during an emotional storm, grounds the soul much more effectively than an hour of imaginary levitation.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : L'Action Sereine</span><span class='en' style='display:none;'>Echo: Serene Action</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Laver une assiette ou balayer une chambre depuis l'espace du Témoin silencieux est la plus haute expression du yoga. Le sacré ne réside pas dans la noblesse de l'acte, mais dans l'espace depuis lequel il est accompli.</div>
        <div class="en" style="display:none;">Washing a plate or sweeping a room from the space of the silent Witness is the highest expression of yoga. The sacred does not lie in the nobility of the act, but in the space from which it is accomplished.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : La Médecine du Repos</span><span class='en' style='display:none;'>Echo: The Medicine of Rest</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">S'endormir par épuisement sur son coussin de méditation n'est pas un échec spirituel. C'est le corps qui réclame la plus ancienne des médecines. Acceptez le sommeil ; le repos est le premier des miracles.</div>
        <div class="en" style="display:none;">Falling asleep from exhaustion on your meditation cushion is not a spiritual failure. It is the body claiming the oldest of medicines. Accept sleep; rest is the first of miracles.</div>
        `
    },
    {
        title: "<span class='fr'>La Porte Étroite de la Simplicité</span><span class='en' style='display:none;'>The Narrow Gate of Simplicity</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Nous savons tous, au fond, que revenir à soi est simple. Il suffit d’un instant d’attention pour sentir le souffle, écouter le silence, et se rappeler que nous ne sommes pas nos pensées. Mais nous préférons souvent le tumulte de l'esprit au vide apparent, car le tumulte nous flatte et nous raconte une histoire où nous sommes les héros, les victimes ou les auteurs.<br><br>Revenir au centre exige un renoncement subtil : celui de ne plus se nourrir de ces drames intérieurs. L'ego se sent menacé par ce retour à la paix, car il se nourrit de ces remous. L'ancien nous rassure, même quand il nous fait souffrir.<br><br>Ce que l'ego redoute comme un vide est en réalité une plénitude vibrante. Retrouver son centre n'est pas une lutte supplémentaire, c'est une détente ; c'est oser ne rien ajouter, ne rien forcer, et se laisser doucement ramener vers la Présence silencieuse.</div>
        <div class="en" style="display:none;">We all know, deep down, that returning to oneself is simple. A moment of attention is enough to feel the breath, listen to the silence, and remember that we are not our thoughts. But we often prefer the tumult of the mind to the apparent emptiness, for the tumult flatters us and tells a story where we are the heroes, the victims, or the authors.<br><br>Returning to the center requires a subtle renunciation: that of no longer feeding on these inner dramas. The ego feels threatened by this return to peace, for it feeds on these disturbances. The old reassures us, even when it causes us to suffer.<br><br>What the ego dreads as an emptiness is actually a vibrant fullness. Finding one's center is not an additional struggle, it is a relaxation; it is daring to add nothing, to force nothing, and to let oneself be gently drawn back to the silent Presence.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : La Force de la Vulnérabilité</span><span class='en' style='display:none;'>Paradox: The Strength of Vulnerability</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Dans l'effort constant pour se durcir, se protéger et se rendre invulnérable, le corps se crispe et les émotions se verrouillent. Cette stratégie de défense consomme une énergie immense et finit inévitablement par nous isoler.<br><br>La véritable vulnérabilité commence précisément quand on cesse de lutter contre le fait d’être affecté. Être touché par le monde n’implique pas automatiquement de s’effondrer. La force réelle réside dans cette capacité à rester présent à ce qui se passe sans se fermer ni se dissoudre.<br><br>Lorsque l'on cesse de masquer ce qui est sensible, la respiration redevient naturelle et les réactions automatiques perdent de leur brutalité. La vraie force n’est pas de ne rien sentir, mais de pouvoir sentir sans se perdre.</div>
        <div class="en" style="display:none;">In the constant effort to harden, protect oneself, and become invulnerable, the body tenses and emotions lock up. This defensive strategy consumes immense energy and inevitably ends up isolating us.<br><br>True vulnerability begins precisely when we stop fighting against the fact of being affected. Being touched by the world does not automatically imply collapsing. Real strength lies in this ability to remain present to what is happening without closing off or dissolving.<br><br>When we stop masking what is sensitive, breathing becomes natural again and automatic reactions lose their brutality. True strength is not feeling nothing, but being able to feel without losing oneself.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : L'Action qui naît du Non-Faire</span><span class='en' style='display:none;'>Paradox: Action Born from Non-Doing</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Nous croyons souvent que l'inaction est une faiblesse et que seul l'effort forcé produit des résultats tangibles. Pourtant, dans la mécanique intime de notre système nerveux, c'est exactement l'inverse qui se produit : c'est lorsque nous cessons d'agiter l'esprit que l'action la plus puissante émerge.<br><br>Le non-faire (ou le lâcher-prise) n'est en aucun cas de la paresse ou de la résignation. C'est l'art subtil de laisser l'intelligence silencieuse du Soi prendre les commandes. Quand l'ego arrête de lutter pour tout contrôler, la tension tombe. L'action qui s'ensuit devient alors fluide, précise, et ne laisse aucun sillage d'épuisement derrière elle.<br><br>Cessez de pousser la rivière ; elle coule toute seule.</div>
        <div class="en" style="display:none;">We often believe that inaction is a weakness and that only forced effort produces tangible results. Yet, in the intimate mechanics of our nervous system, the exact opposite occurs: it is when we stop agitating the mind that the most powerful action emerges.<br><br>Non-doing (or letting go) is by no means laziness or resignation. It is the subtle art of letting the silent intelligence of the Self take the wheel. When the ego stops fighting to control everything, tension drops. The resulting action then becomes fluid, precise, and leaves no wake of exhaustion behind it.<br><br>Stop pushing the river; it flows by itself.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : La Constance Invisible</span><span class='en' style='display:none;'>Echo: The Invisible Constancy</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">La véritable transformation spirituelle ne s'annonce jamais avec des trompettes ou des éclairs de lumière. Elle obéit à la loi de la nature, ressemblant à la croissance d'un arbre : totalement invisible au jour le jour, mais indéniable au fil des saisons.<br><br>L'erreur est de vouloir évaluer votre pratique méditative à la fin de chaque séance. Ne vous jugez pas si votre esprit a vagabondé, ne cherchez pas le silence parfait. La constance est la seule véritable magie. <br><br>C'est l'accumulation discrète de ces minutes passées à revenir doucement au centre, jour après jour, qui, goutte après goutte, finit par dissoudre le roc de vos plus anciennes tensions.</div>
        <div class="en" style="display:none;">True spiritual transformation never announces itself with trumpets or flashes of light. It obeys the law of nature, resembling the growth of a tree: totally invisible day by day, but undeniable as the seasons pass.<br><br>The mistake is wanting to evaluate your meditation practice at the end of each session. Do not judge yourself if your mind has wandered, do not seek perfect silence. Constancy is the only real magic.<br><br>It is the quiet accumulation of these minutes spent gently returning to the center, day after day, that, drop by drop, eventually dissolves the rock of your oldest tensions.</div>
        `
    },
    {
        title: "<span class='fr'>Écho : Le Regard sans Intervention</span><span class='en' style='display:none;'>Echo: The Gaze Without Intervention</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">L'une des pratiques les plus profondes ne demande aucun effort physique. C'est le simple fait d'observer.<br><br>Lorsque la tempête fait rage à l'intérieur — une émotion forte, une peur sourde ou une pensée obsédante —, notre réflexe mécanique est toujours d'intervenir. Nous voulons fuir, comprendre, analyser ou combattre ce qui nous dérange. La prochaine fois, essayez de ne rien faire. Contentez-vous d'observer le phénomène avec douceur, comme s'il s'agissait d'un nuage sombre traversant votre ciel intérieur.<br><br>Ce regard neutre, dénué de tout jugement et de toute volonté de modifier l'instant, est le scalpel le plus tranchant de la conscience. Sous la lumière de cette attention sans effort, les nœuds les plus anciens finissent toujours par se défaire d'eux-mêmes.</div>
        <div class="en" style="display:none;">One of the most profound practices requires no physical effort. It is the simple act of observing.<br><br>When a storm rages inside—a strong emotion, a dull fear, or an obsessive thought—our mechanical reflex is always to intervene. We want to flee, understand, analyze, or fight what disturbs us. Next time, try doing nothing. Simply observe the phenomenon gently, as if it were a dark cloud crossing your inner sky.<br><br>This neutral gaze, devoid of any judgment and any desire to change the moment, is the sharpest scalpel of consciousness. Under the light of this effortless attention, the oldest knots always end up untying themselves.</div>
        `
    },
    {
        title: "<span class='fr'>Paradoxe : Oser Perdre pour Trouver</span><span class='en' style='display:none;'>Paradox: Daring to Lose to Find</span>",
        audioFile: "", imageFile: "", videoFile: "",
        text: `
        <div class="fr">Le monde moderne nous vend souvent l'idée qu'il faut ajouter des qualités à notre personne : devenir plus fort, plus calme, plus sage. Nous abordons la spiritualité comme une accumulation de richesses supplémentaires.<br><br>La véritable libération obéit pourtant à la loi inverse : la soustraction. L'éveil n'est pas l'acquisition d'un état supérieur, mais la perte progressive de nos illusions, de nos tensions accumulées et de nos mécanismes de défense. C'est un effeuillage. <br><br>C'est en osant perdre cette fausse sécurité que nous offre le contrôle, et en acceptant d'être mis à nu par le silence, que l'on découvre la seule chose qui ne pourra jamais nous être enlevée : notre véritable nature.</div>
        <div class="en" style="display:none;">The modern world often sells us the idea that we must add qualities to our persona: becoming stronger, calmer, wiser. We approach spirituality as an accumulation of additional wealth.<br><br>True liberation, however, obeys the opposite law: subtraction. Awakening is not the acquisition of a higher state, but the gradual loss of our illusions, our accumulated tensions, and our defense mechanisms. It is a stripping away.<br><br>It is by daring to lose this false security offered by control, and by agreeing to be laid bare by silence, that we discover the only thing that can never be taken from us: our true nature.</div>
        `
    },
    {
    ...
    },
   {
        ...
        <div class="fr">
            ...
            Dans les temples de pierre, les livres sacrés, les rituels complexes.<br>
            Dans les montagnes lointaines, les gourous charismatiques, les expériences extrêmes.<br>
            Dans la souffrance, la privation, ou au contraire dans l'extase sensorielle.<br>
            Dans les dogmes, les certitudes, les "il faut" et les "tu dois".</p>
            
            <p><strong>Ils le cherchent aussi dans le mental :</strong><br>
            En intellectualisant, en disséquant les textes comme des anatomistes de l'âme.<br>
            En accumulant des connaissances spirituelles comme on collectionne des objets.<br>
            En se perdant dans des débats sans fin sur "qui a raison".</p>
            
            <p><strong>Et parfois, ils le cherchent dans l'émotion :</strong><br>
            Dans les vagues de dévotion qui submergent, les larmes, les chants enflammés.<br>
            Dans l'attente d'un signe, d'une révélation, d'une preuve tangible.</p>
            ...
            <p style="text-align: center; font-family: 'Cinzel', serif; color: #5b8cba; letter-spacing: 2px;">COMMENT LE CHERCHER EN RÉALITÉ ?</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Cesse de chercher :</strong> La quête elle-même est l'obstacle. Le système nerveux ne peut pas se détendre dans la recherche. Il se tend, il s'agite.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Nettoie le tuyau :</strong> La Respiration Spinale (cette attention qui monte et descend le long de la colonne, sans forcer, comme un fil de soie) est la brosse qui dissout les dépôts.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Assieds-toi dans le Silence :</strong> La Méditation Profonde avec le mantra AYAM n'est pas une technique pour "atteindre" Dieu. C'est une pratique pour <em>désapprendre</em> tout ce qui n'est pas Lui.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Laisse l'énergie monter :</strong> Quand la Shakti s'éveille, elle peut créer des secousses. Ne fuis pas. Ne te cramponne pas. Accueille, comme on accueille une vague sans vouloir la retenir.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Vois le monde comme un miroir :</strong> Reconnaître que chaque action, même la plus banale, est une offrande si elle est faite sans attachement.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Ne force rien :</strong> La loi de l'effort inverse est absolue. Comme une porte qui ne s'ouvre que si tu la tires vers toi, la spiritualité se révèle quand tu cesses de tirer.</p>
            
            <p style="text-align: center; font-style: italic; margin-top: 30px; border-top: 1px solid rgba(212, 175, 55, 0.2); padding-top: 20px;">
                Imagine une graine enterrée dans le sol. Elle ne "cherche" pas la lumière. Elle se contente de devenir ce qu'elle est. La chaleur, l'eau, la terre font le reste. Toi aussi, deviens ce que tu es — et laisse le reste se faire.
            </p>
        </div>
        ...
        <div class="en" style="display:none;">
            ...
            In stone temples, sacred books, complex rituals.<br>
            In distant mountains, charismatic gurus, extreme experiences.<br>
            In suffering, deprivation, or conversely, in sensory ecstasy.<br>
            In dogmas, certainties, the "musts" and the "shoulds".</p>
            
            <p><strong>They also seek Him in the mind:</strong><br>
            By intellectualizing, dissecting texts like anatomists of the soul.<br>
            By accumulating spiritual knowledge the way one collects objects.<br>
            By getting lost in endless debates over "who is right".</p>
            
            <p><strong>And sometimes, they seek Him in emotion:</strong><br>
            In overwhelming waves of devotion, tears, impassioned chants.<br>
            In the expectation of a sign, a revelation, a tangible proof.</p>
            ...
            <hr style="border: 0; border-top: 1px dashed var(--border-color); margin: 25px 0;">
            <p style="text-align: center; font-family: 'Cinzel', serif; color: #5b8cba; letter-spacing: 2px;">HOW TO TRULY SEEK HIM?</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Stop seeking:</strong> The quest itself is the obstacle. The nervous system cannot relax in the search. It tenses, it becomes agitated.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Clean the pipe:</strong> Spinal Breathing (that attention moving up and down the spine, without forcing, like a silk thread) is the brush that dissolves the deposits.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Sit in Silence:</strong> Deep Meditation with the mantra AYAM is not a technique to "reach" God. It is a practice to <em>unlearn</em> everything that is not Him.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Let the energy rise:</strong> When Shakti awakens, it can create tremors. Do not flee. Do not cling. Welcome it, as one welcomes a wave without trying to hold it back.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>See the world as a mirror:</strong> Recognizing that every action, even the most mundane, is an offering if done without attachment.</p>
            
            <p><span style="color: var(--accent-color);">✧</span> <strong>Force nothing:</strong> The law of reversed effort is absolute. Like a door that only opens if you pull it toward you, spirituality reveals itself when you stop pulling.</p>
            
            <p style="text-align: center; font-style: italic; margin-top: 30px; border-top: 1px solid rgba(212, 175, 55, 0.2); padding-top: 20px;">
                Imagine a seed buried in the soil. It does not "seek" the light. It simply becomes what it is. The heat, the water, the earth do the rest. You too, become what you are—and let the rest unfold.
            </p>
        </div>
        `
    }
